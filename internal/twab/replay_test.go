...
// streak. That is the literal reading and the one that cannot be gamed — a wallet could
// otherwise park a streak while shuffling. It is a reading rather than a §5 resolution, so
// it is pinned here rather than in a Case: see ticket 02's comments.
